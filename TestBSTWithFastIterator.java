...
public class TestBSTWithFastIterator {
	...
	public static ArrayList<ArrayList<Integer>> timeIterator(BST<Integer> bst) {
		...
		System.out.printf("\tTime to iterate through " + NUM_VALUES_TAKEN_AT_FIRST + " values:  %1.3f seconds\n",
				seconds);
		...
		endTime = System.currentTimeMillis();
		seconds = (endTime - startTime) / 1000.0;
		System.out.printf("\tTime to iterate through all " + bst.size() + " values:  %1.3f seconds\n", seconds);
		returnValue.add(valuesFromIter);
		...
		endTime = System.currentTimeMillis();
		seconds = (endTime - startTime) / 1000.0;
		System.out.printf("\tTime to iterate through remaining " + bst.size() + " values:  %1.3f seconds\n", seconds);
